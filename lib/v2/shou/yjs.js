...
const host = 'https://yjs.shou.edu.cn';
module.exports = async (ctx) => {
    ...
    const typeName = $('.slide-nav-ul a.selected').text() || '研究生院';
    const list = $('.main-right .right-nr > ul li');
    ...
    ctx.state.data = {
        title: `上海海洋大学研究生院 - ${typeName}`,
        link: pageUrl,
        description: `上海海洋大学研究生院 - ${typeName}`,
        item: items,
    };
};
